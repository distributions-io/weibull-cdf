...
describe( 'deepset cdf', function tests() {
	...
	it( 'should compute the Weibull cdf and deep set', function test() {
		var data, expected, i;
	...
	it( 'should return an empty array if provided an empty array', function test() {
		assert.deepEqual( cdf( [], lambda, k, 'x' ), [] );
		assert.deepEqual( cdf( [], lambda, k, 'x', '/' ), [] );
	});
